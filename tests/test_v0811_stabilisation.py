...
def test_wallet_buttons_and_execution_buttons_use_multi_selector():
    ...
    assert "$('.wallet-provider-choice').forEach" not in js
...
def test_live_fee_growth_math_includes_unrealised_accrual_not_only_stored_owed():
    ...
    # feeGrowthInside0 = 1000 - 100 - 200 = 700 Q128.
    # Position last = 600 Q128, liquidity 10 => +1000 raw, plus stored owed 3.
